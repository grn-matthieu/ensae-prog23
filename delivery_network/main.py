from graph import Graph, Union_Find, graph_from_file, graph_into_pdf, kruskal, find_path_with_kruskal, determine_parents
import os
import time
import random
...
def estimate_time():
    ...
    print(f'Pour 200K trajet : {tps} secondes')
